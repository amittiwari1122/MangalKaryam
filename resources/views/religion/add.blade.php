...
@section('content')
    ...
    <div class="br-mainpanel">
      ...
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Religion Add Form</h4>
        <p class="mg-b-0">Master Tables</p>
      </div>

      <div class="br-pagebody">
        <div class="br-section-wrapper">
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Religion Add Page</h6>
        ...
        @endif
          <form method="POST" action="/saveReligion" />
          @csrf
            ...
            <div class="row mg-b-25">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="name" value="" placeholder="Please enter religion">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                <div class="form-group">
