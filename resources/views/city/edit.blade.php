    ...
    <div class="br-mainpanel">
      <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <a class="breadcrumb-item" href="/getCity">City</a>
          <span class="breadcrumb-item active">Edit Form</span>
        </nav>
      </div><!-- br-pageheader -->
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">City Edit Form</h4>
        <p class="mg-b-0">Master Tables</p>
      </div>

      <div class="br-pagebody">
        <div class="br-section-wrapper">
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">City Edit Page</h6>
        ...
        @endif
          <form method="POST" action="/saveUpdateCity/<?php echo $city->id; ?>" />
          @csrf
            ...
            <div class="row mg-b-25">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="name" value="<?php echo $city->name; ?>" placeholder="Enter state name">
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="description" value="<?php echo $city->description; ?>" placeholder="Enter description">
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-6">
                <div class="form-group mg-b-10-force">
                  ...
                  <select class="form-control select2" name="state_id" data-placeholder="Choose State">
