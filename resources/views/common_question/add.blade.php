    ...
    <div class="br-mainpanel">
      <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <a class="breadcrumb-item" href="/getCommonQuestion">Common Question</a>
          <span class="breadcrumb-item active">Add Form</span>
        </nav>
      </div><!-- br-pageheader -->
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Common Question Add Form</h4>
        <p class="mg-b-0">Master Tables</p>
      </div>

      <div class="br-pagebody">
        <div class="br-section-wrapper">
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Common Question Add Page</h6>
        ...
        @endif
          <form method="POST" action="/saveCommonQuestion" >
          @csrf
            ...
            <div class="row mg-b-25">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="question" value="" placeholder="Enter Common Question">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label">Answer: </label>
                  <input class="form-control" type="text" name="answer" value="" placeholder="Enter Answer">
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-6">
                <div class="form-group mg-b-10-force">
                  ...
                  <select class="form-control select2" name="type" data-placeholder="Choose User Type">
