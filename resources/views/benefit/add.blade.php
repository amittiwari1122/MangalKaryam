...
@section('content')
    ...
    <div class="br-mainpanel">
      ...
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Benefits Add Form</h4>
        <p class="mg-b-0">Master Tables</p>
      </div>

      <div class="br-pagebody">
        <div class="br-section-wrapper">
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Benefits Add Page</h6>
        ...
        @endif
          <form method="POST" action="/saveBenefit" />
          @csrf
            ...
            <div class="row mg-b-25">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="question" value="" placeholder="Please enter Question">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                <div class="form-group">
              ...
              <div class="col-lg-6">
                <div class="form-group mg-b-10-force">
                  ...
                  <select class="form-control select2" name="section" data-placeholder="Choose Section Type">
