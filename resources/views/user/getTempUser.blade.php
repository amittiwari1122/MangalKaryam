    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pagebody">
        <div class="br-section-wrapper">
          ...
          @if (session('message'))
              <div class="alert" style="color:green">{{ session('message') }}</div>
          @endif
          <!-- <p class="mg-b-25 mg-lg-b-50"><a href="/addUser" class="btn btn-info">Add New Users</a></p> -->
          <form class="" action="/getTUser" method="post">
            @csrf
            ...
            <table id="datatable2" class="table display responsive nowrap">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="/editTempUser/<?php echo $udata->id; ?>"><i class="fa fa-pencil" ></i></a></td>
                </tr>
              <?php } ?>
              </tbody>
            </table>
